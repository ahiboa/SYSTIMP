...
$query="select e.event_id, e.event_name, e.event_date_time, c.client_name from
               ...
               on e.event_id=p.payment_event_id where p.status = 'Unpaid' and e.status = 'Approved'";
...
$query2="select c.client_name, p.payment_event_id, e.event_name, p.totalprice, 
...
$confirmedid = $_SESSION['event_select'];
        ...
        set status = 'Paid', date = now(), payment_type = 'Cash'
